...
function freePlanMessage(name) {
  ...
  return (
    greeting +
    "AI answers and smart file search are premium features, and your account " +
    "is on the *FREE* plan.\n\n" +
    "Move to the *PAID* plan to unlock them. You can still get any document — " +
    "just type the *exact file name* (for example \"APMR-A\" or \"ACMR IOM\"). " +

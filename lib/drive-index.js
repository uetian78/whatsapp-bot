...
//
// Native Google Docs/Sheets are deliberately NOT included: they carry a
// google-apps mimeType, have no file extension, and need an export step
// rather than a plain download, so indexing them would surface files the
// bot then fails to send.
...
module.exports = {
  listFolderFiles, isIndexableFile, INDEXABLE_EXT, docTypeFromFilename, folderMatchesDocType, fileMatchesDocType,
